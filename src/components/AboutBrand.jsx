...
export default function AboutBrand() {
  ...
  return (
    <section id="sobre-nosotros" style={{ background: "#0A0A09", padding: "112px 48px", fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "0.9fr 1.1fr", gap: "80px", alignItems: "center" }}>
        <div style={{ position: "relative", height: "420px", border: "1px solid #3A3A38" }}>
        ...
        <div>
          ...
          <h2 style={{ color: "#EDEAE2", fontFamily: "'Georgia', 'Times New Roman', serif", fontWeight: 400, fontSize: "36px", lineHeight: 1.25, margin: "0 0 28px", maxWidth: "520px" }}>
